...
#ifdef DEFAULTS_FABSCAN
  // Grbl default settings for fabscan board and nema17 steppers
// Description: Sherline 5400 mill with three NEMA 23 Keling  KL23H256-21-8B 185 oz-in stepper motors,
  // driven by three Pololu A4988 stepper drivers with a 30V, 6A power supply at 1.5A per winding.
  #define MICROSTEPS 4
  #define STEPS_PER_REV 200.0
  #define MM_PER_REV 1.0 
  #define DEFAULT_X_STEPS_PER_MM (STEPS_PER_REV*MICROSTEPS/MM_PER_REV)
  #define DEFAULT_Y_STEPS_PER_MM (STEPS_PER_REV*MICROSTEPS/MM_PER_REV)
  #define DEFAULT_Z_STEPS_PER_MM (STEPS_PER_REV*MICROSTEPS/MM_PER_REV)
  #define DEFAULT_STEP_PULSE_MICROSECONDS 20
  #define DEFAULT_MM_PER_ARC_SEGMENT 0.1
  #define DEFAULT_RAPID_FEEDRATE 120.0 // mm/min
  #define DEFAULT_FEEDRATE 100.0 // mm/min
  #define DEFAULT_ACCELERATION 37.0*60*60 // 150*60*60 mm/min^2 = 150 mm/s^2
  #define DEFAULT_JUNCTION_DEVIATION 0.05 // mm
  ...
  #define DEFAULT_HOMING_DIR_MASK 0 // move positive dir
  #define DEFAULT_HOMING_RAPID_FEEDRATE 80.0 // mm/min
  #define DEFAULT_HOMING_FEEDRATE 20.0 // mm/min
  #define DEFAULT_HOMING_DEBOUNCE_DELAY 100 // msec (0-65k)
  #define DEFAULT_HOMING_PULLOFF 1.0 // mm
  #define DEFAULT_HOMING_ENDSTOP_X 134 // x endstop is at 134
  #define DEFAULT_STEPPER_IDLE_LOCK_TIME 25 // msec (0-255)
  #define DEFAULT_DECIMAL_PLACES 3
  #define DEFAULT_N_ARC_CORRECTION 25
#endif
